...
const uglify = require('gulp-uglify-es').default; // Подключаем gulp-uglify (для сжатия JS)
...
const image = require('gulp-image'); // Подключаем библиотеку для работы с изображениями
...
// function cssLibs() {
//   return gulp.src([]) // Сюда добавляем сss библиотеки
...
gulp.task('build', gulp.series(clean, gulp.parallel('styles', 'scripts', 'images'), 'fonts', 'code'))
